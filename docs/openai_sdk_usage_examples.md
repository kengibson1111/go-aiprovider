...
- [OpenAI SDK Usage Examples](#openai-sdk-usage-examples)
  - [Table of Contents](#table-of-contents)
  - [Basic Setup and Configuration](#basic-setup-and-configuration)
    - [Standard Configuration](#standard-configuration)
    - [Azure OpenAI Configuration](#azure-openai-configuration)
  - [Basic Prompt Completion](#basic-prompt-completion)
    - [Simple Prompt Completion](#simple-prompt-completion)
    - [Best Practice: Context Management](#best-practice-context-management)
  ...
  - [High-Level Interface Usage](#high-level-interface-usage)
  ...
  - [Performance Optimization Tips](#performance-optimization-tips)
    ...
    - [Connection Reuse Best Practices](#connection-reuse-best-practices)
  - [Migration from JSON-based Implementation](#migration-from-json-based-implementation)
    - [Before (JSON-based)](#before-json-based)
    - [After (SDK-based)](#after-sdk-based)
  - [Summary](#summary)
