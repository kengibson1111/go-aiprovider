...
// BasicUsageExample demonstrates creating a Bedrock client and making a simple prompt call.
...
func ErrorHandlingExample(factory *client.ClientFactory) {
	...
	// Use a bogus model ID to trigger an error
	config := &types.AIConfig{
		Provider:    "claude-bedrock",
		Model:       "invalid-model-id-for-testing",
		MaxTokens:   100,
		Temperature: 0.7,
	}
...
func main() {
	fmt.Println("Claude Bedrock SDK - Basic Usage Examples")
	fmt.Println("==========================================")
